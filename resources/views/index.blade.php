            ...
            <div class="container-fluid py-5 px-4 px-md-5">
                <div class="row align-items-center">
                    <div class="col-lg-6 position-relative z-1 py-3">
                        <h1 class="display-4 fw-bold mb-3" style="letter-spacing: -1px;">Lorem Ipsum<br>Dolor sit amet</h1>
                        <p class="fs-5 mb-4 text-white-50">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In
                            vulputate fermentum ligula, non ornare ligula eleifend et. Sed in nisl in mauris malesuada
                            placerat sed quis ex</p>
